...
public class PermissionsActivity extends Activity {
    ...
    private void handlePermissionsFailure() {
        new AlertDialog.Builder(this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT).setTitle(getResources().getString(R.string.camera_error_title))
    ...
    // Scene: No location permission, start from system ui
